					...
					<div className='columns'>
						<div className='column is-half'>
							...
							<div className='comments'>
								<ul className='is-7 has-text-dark'>
									{jet.comments.map(comment => (
										<li key={comment._id}>
											{comment.text}
						...
						<div className='column is-half'>
							<h4 className='title is-4 has-text-dark'>
								Commercial: {jet.commercial ? 'Yes' : 'No'}
							</h4>
							<h4 className='title is-4 has-text-dark'>
								Operational: {jet.operational ? 'Yes' : 'No'}
							</h4>
							...
							{this.isOwner() && (
								<div className='column'>
									<Link
										to={`/jets/${jet._id}/edit`}
										className='button is-warning edit-button'
									>
										Edit
									</Link>
									<button
